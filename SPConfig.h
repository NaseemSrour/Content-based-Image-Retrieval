...
enum lineType isValidLine(char* line);
/**
...
/**
 * Returns the Number Of similar Images.
 *
 * @param config - the configuration structure
 * @assert msg != NULL
 * @param msg - pointer in which the msg returned by the function is stored
 ...
 *
 * @param loggerLevel - the level of the logger that we have to update.
 * @param config - the configuration structure
 *
 *@return
 * - SP_CONFIG_INVALID_ARGUMENT - if loggerFileName == NULL or config == NULL
...
/**
 * return the splititing Method that we will split the KDaArray with it.
 *
 * @param config - the configuration structure
 * @assert msg != NULL
 * @param msg - pointer in which the msg returned by the function is stored
 * @return the splititing Method (enum)
 *
 * - SP_CONFIG_INVALID_ARGUMENT - if config == NULL
 * - SP_CONFIG_SUCCESS - in case of success
 */
